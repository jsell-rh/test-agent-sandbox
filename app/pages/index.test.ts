 ...
 *     4. Exposes clearCompleted as a spy so tests can assert it is called.
 ...
 *   clearCompleted) is covered exhaustively in useTodos.test.ts.
 */
...
vi.mock('../composables/useTodos', async (importOriginal) => {
  ...
  return {
    ...
    useTodos: () => {
      ...
      return { todos, filter, editingTodoId, filteredTodos, counts, loadTodos, createTodo, clearCompleted }
    },
  }
})
